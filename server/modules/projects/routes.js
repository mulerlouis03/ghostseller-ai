...
projectRouter.get("/dashboard",requireAuth,async(req,res)=>{
 ...
 res.json({user:safeUser(req.user),projects:projects.data||[],posts:posts.data||[],leads:leads.data||[],trends:trends.data||[],autoCampaigns:autoCampaigns.data||[],videos:videos.data||[]});
});
